...
public class Creator {
    ...
    public static Restaurant[] createFastFoodRestaurants() {
        ...
        pepperoni.setDishPrice(new BigDecimal(10));
        Dish italiano = new Pizza("Italiano", 16);
        italiano.setDishPrice(new BigDecimal(12));
        Dish bbqPizza = new Pizza("BBQ Pizza", 20);
        bbqPizza.setDishPrice(new BigDecimal(9));
        ...
        whopper.setDishPrice(new BigDecimal(10));
        Dish bigKing = new Hamburger("Big King", 11);
        bigKing.setDishPrice(new BigDecimal(9));
        Dish hamburger = new Hamburger("Hamburger", 7);
        hamburger.setDishPrice(new BigDecimal(7));
